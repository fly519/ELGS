...
output_allfilelist = os.path.join(output_dir, 'all_files.txt')
fout_allfilelist = open(output_allfilelist, 'w')
...
def insert_batch(data, label, last_batch=False):
    ...
    if buffer_size + data_size <= h5_batch_data.shape[0]:
        ...
        fout_allfilelist.write(h5_filename+"\n")
        fout_allfilelist.flush()
