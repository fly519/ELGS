...
parser.add_argument('--ckpt_dir', default='log', help='ckpt file [default: best_seg_model.ckpt.meta]')
    ...
    with tf.Graph().as_default():
        ...
        for filename in os.listdir(CKPT_DIR):
            ...
            if filename.endswith("ckpt.meta"):
                ...
                new_saver = tf.train.import_meta_graph(CKPT_DIR+filename)
                new_saver.restore(sess, CKPT_DIR+filename.split('.meta')[0])
                print("Current model:"+filename.split('.meta')[0])
